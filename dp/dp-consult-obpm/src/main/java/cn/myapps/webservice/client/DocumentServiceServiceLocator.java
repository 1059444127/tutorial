...
public class DocumentServiceServiceLocator extends org.apache.axis.client.Service implements cn.myapps.webservice.client.DocumentServiceService {
    ...
    //private java.lang.String DocumentService_address = "http://10.28.13.185:99/obpm/services/DocumentService";
    private java.lang.String DocumentService_address = "http://192.168.2.138:99/obpm/services/DocumentService";
    ...
    public cn.myapps.webservice.client.DocumentService getDocumentService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            cn.myapps.webservice.client.DocumentServiceSoapBindingStub _stub = new cn.myapps.webservice.client.DocumentServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (cn.myapps.webservice.client.DocumentService.class.isAssignableFrom(serviceEndpointInterface)) {
                cn.myapps.webservice.client.DocumentServiceSoapBindingStub _stub = new cn.myapps.webservice.client.DocumentServiceSoapBindingStub(new java.net.URL(DocumentService_address), this);
                _stub.setPortName(getDocumentServiceWSDDServiceName());
                return _stub;
            }
        }
